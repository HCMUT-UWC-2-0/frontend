...
export const ResetScreen: IComponent = () => {
  ...
  return (
    <div className="font-sans flex w-full h-full justify-center items-center flex-col gap-2 pb-40 animate__animated animate__bounceIn">
      ...
      <h1 className="text-2xl font-bold text-teal-700" style={{ paddingTop: "150px" }}>Tạo mật khẩu mới</h1>
      <form
      ...
      {showSuccessPopup && (
        ...
        <div className="bg-white w-96 rounded-lg p-8">
          ...
          <h2 className="text-3xl font-bold text-teal-800 mb-4 text-center">Đổi mật khẩu thành công!</h2>
          <div className="border-b border-gray-300 mb-4" />
          <p className="py-4 font-bold text-gray-800 text-center px-4">Mật khẩu đã được cập nhật</p>
      ...
      {showErrorPopup && (
        ...
        <div className="bg-white w-96 rounded-lg p-8">
          ...
          <h2 className="text-2xl font-bold text-gray-800 mb-4 text-center">Mật khẩu không trùng khớp, xin nhập lại</h2>
        </div>
      </div>
      )}
    </div> 
